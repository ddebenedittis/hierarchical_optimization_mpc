...
from distributed_ho_mpc.scenarios.formation_obstacle_omni.ho_mpc.ho_mpc_multi_robot import HOMPCMultiRobot, TaskIndexes, TaskType, TaskBiCoeff
from distributed_ho_mpc.scenarios.formation_obstacle_omni.message import MessageSender, MessageReceiver
from distributed_ho_mpc.scenarios.formation_obstacle_omni.ho_mpc.robot_models import get_omnidirectional_model, RobCont
    ...
    def MPC(self)->None:
        ...
        for task in self.tasks:
                    if task['name'] == "input_limits":
                        ...
                        aux, mapping, task_formation, task_formation_coeff, f_robot_idx = self.task_formation_method(
