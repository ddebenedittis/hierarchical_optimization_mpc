...
class Node:
    ...
    def Tasks(self) -> None:
        ...
        self.task_input_min = RobCont(
            ...
            uni=ca.vertcat(self.u.omni[0], self.u.omni[1]),
        )
        ...
        self.mapping_avoid_collision_o = RobCont(omni=ca.vertcat(self.s.omni[0], self.s.omni[1]))
